   ...
   return (
      <section id='works'>
         ...
         <div className="worksImgs">
            <a href="https://ev-web-three.vercel.app/" target="_blank" rel="noopener noreferrer"><div className='works-div' ><img src={Portfolio1} alt="Portfolio1" className="worksImg" /> <div className="hover"><p>Go to Project</p></div> </div></a>
            ...
            <a href="https://netflix-clone-fst.vercel.app/" target="_blank" rel="noopener noreferrer"><div className="works-div"><img src={Portfolio6} alt="Portfolio6" className="worksImg" /><div className="hover"><p>Go to Project</p></div></div></a>
         </div>
