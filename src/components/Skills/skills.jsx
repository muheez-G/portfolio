	...
	return (
		<section id='skills'>
			...
			<span className="skillDesc" data-aos="fade-up" data-aos-delay="100">
				I'm a creative frontend developer passionate about turning ideas into scalable, user-focused web products. Skilled in HTML, CSS, JavaScript, TypeScript, 
				and React, I craft clean, strategic solutions that deliver standout user experiences.
			</span>
			...
			<div className="skillBars" data-aos="fade-right" data-aos-delay="200">
				<div className="skillBar">
					...
					<div className="skillBartext">
						...
						<p id='p'>I'm a UI/UX designer passionate about creating intuitive, visually engaging digital experiences that people genuinely enjoy using.</p>
					</div>
				</div>	
			</div>
			...
			<div className="skillBars" data-aos="fade-left" data-aos-delay="300">
				<div className="skillBar">
					...
					<div className="skillBartext">
						...
						<p id='p'>Passionate about clean code and cleaner design, I craft modern, engaging websites that tell compelling stories and deliver real results.</p>
					</div>
				</div>	
			</div>
